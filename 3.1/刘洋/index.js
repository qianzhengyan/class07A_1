...
// var Hi = person.sayHi;
// Hi();
// Hello, undefined  将person.sayHi赋值给Hi  应用了默认绑定  相当于直接调用sayHi()
...
//将person.sayHi传入Hi 相当于person.sayHi被赋值给fn 默认绑定 此时指向window或者全局
//然后用call改变了this指向 让传入的函数的this改为Hi的this
//最后改变Hi的this 指向person 
